...
Both works lean on the same piece of machinery for handling these maps analytically: Schröder's functional equation [@curtright2011rg],
...
**Related:** [Mean-Field Theory and Annealed Disorder](/explainers/mean-field-annealed-disorder/) is a refresher on the annealed approximation this post's belief-propagation map relies on, worked through the classical Curie-Weiss ferromagnet.
